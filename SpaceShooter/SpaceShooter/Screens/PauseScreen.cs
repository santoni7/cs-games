...
namespace SpaceShooter.Screens
{
    class PauseScreen:Screen
    {
        ...
        public PauseScreen(string name, ScreenManager screenManager) : base(name, screenManager)
        {
            items.Add(new MenuItem()
            {
                ...
                IsHovered = true,
                OnClicked =
                   () => { screenManager.ClearBackground();screenManager.SetActiveScreen("main",false); }
            });
            items.Add(new MenuItem()
            {
                Caption = "Main menu",
